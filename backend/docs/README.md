...
This directory contains detailed documentation for the Agent Workspace backend.
...
1. **New to Agent Workspace?** Start with [SETUP.md](SETUP.md) for quick installation
