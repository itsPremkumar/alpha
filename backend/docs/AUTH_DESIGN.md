...
- `token_version += 1`。
- 设置 `needs_setup=true`。
- 写入 `.agent-workspace/admin_initial_credentials.txt`，权限 `0600`。
...
| `packages/harness/agent_workspace/config/auth_config.py` | OIDC 配置模型（OIDCProviderConfig / OIDCAuthConfig） |
