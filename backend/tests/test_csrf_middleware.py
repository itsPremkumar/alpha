...
def test_url_reconstruction_cannot_create_a_csrf_exemption():
    client = TestClient(_make_app(), base_url="https://agent_workspace.example")
...
def test_csrf_uses_the_same_root_path_projection_as_the_router():
    ...
    response = TestClient(
        parent,
        base_url="https://agent_workspace.example",
...
def test_auth_post_allows_same_origin_browser_request():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://agent_workspace.example"},
    )
...
def test_auth_post_rejects_malformed_origin_with_path():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://agent_workspace.example/path"},
    )
...
def test_auth_post_rejects_malformed_origin_with_invalid_port():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://agent_workspace.example:bad"},
    )
...
def test_auth_post_allows_same_origin_default_port_equivalence():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://agent_workspace.example:443"},
    )
...
def test_auth_post_allows_forwarded_same_origin():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={
            "Origin": "https://agent_workspace.example",
            "X-Forwarded-Proto": "https",
            "X-Forwarded-Host": "agent_workspace.example, internal:8000",
        },
    )
...
def test_auth_post_allows_rfc_forwarded_same_origin():
    ...
    response = client.post(
        ...
        headers={
            "Origin": "https://agent_workspace.example",
            "Forwarded": "proto=https;host=agent_workspace.example",
        },
    )
