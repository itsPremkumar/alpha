...
The agent-workspace-harness package (packages/harness/agent_workspace/) is a standalone,
...
HARNESS_ROOT = Path(__file__).parent.parent / "packages" / "harness" / "agent_workspace"
