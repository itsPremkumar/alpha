...
from alpha.config.app_config import apply_logging_level, logging_level_from_config
...
class TestApplyLoggingLevel:
    """Tests for ``apply_logging_level`` — verifies alpha/app logger and handler levels."""
    ...
    def test_defaults_to_info(self) -> None:
        ...
        assert logging.getLogger("alpha").level == logging.INFO
