"""Strict Blockbuster runtime context scoped to Agent Workspace business code.
...
# Add Agent Workspace-local rules here only when Blockbuster's default rule set misses
