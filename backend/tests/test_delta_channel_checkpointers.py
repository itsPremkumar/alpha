...
from alpha.agents.thread_state import DeltaThreadState, merge_message_writes
from alpha.runtime.checkpoint_mode import CHECKPOINT_MODE_METADATA_KEY, checkpoint_tuple_uses_delta
from alpha.runtime.checkpoint_state import CheckpointStateAccessor
from alpha.runtime.goal import write_thread_goal
from alpha.runtime.runs.worker import _ensure_interrupted_title, persist_run_durations
...
# ---------------------------------------------------------------------------
# InMemorySaver delta-history patch guards (alpha.checkpoint_patches)
# ---------------------------------------------------------------------------
