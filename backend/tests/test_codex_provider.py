...
from agent_workspace.models.credential_loader import CodexCliCredential
...
def _make_model(**kwargs):
    ...
    with patch("agent_workspace.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
