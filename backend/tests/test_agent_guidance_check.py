...
EXPECTED_GUIDANCE_PATHS = {
    ...
    "backend/packages/harness/agent_workspace/AGENTS.md",
    "backend/packages/harness/agent_workspace/agents/AGENTS.md",
    "backend/packages/harness/agent_workspace/agents/middlewares/AGENTS.md",
    "backend/packages/harness/agent_workspace/agents/memory/AGENTS.md",
    "backend/packages/harness/agent_workspace/config/AGENTS.md",
    "backend/packages/harness/agent_workspace/extensions/AGENTS.md",
    "backend/packages/harness/agent_workspace/runtime/AGENTS.md",
    "backend/packages/harness/agent_workspace/sandbox/AGENTS.md",
    "backend/packages/harness/agent_workspace/mcp/AGENTS.md",
    "backend/packages/harness/agent_workspace/models/AGENTS.md",
    "backend/packages/harness/agent_workspace/persistence/migrations/AGENTS.md",
    "backend/packages/harness/agent_workspace/reflection/AGENTS.md",
    "backend/packages/harness/agent_workspace/skills/AGENTS.md",
    "backend/packages/harness/agent_workspace/subagents/AGENTS.md",
    "backend/packages/harness/agent_workspace/tools/AGENTS.md",
    "backend/packages/harness/agent_workspace/tracing/AGENTS.md",
    "backend/packages/harness/agent_workspace/tui/AGENTS.md",
    "backend/packages/harness/agent_workspace/utils/AGENTS.md",
...
def test_local_guidance_files_contain_the_split_original_sections() -> None:
    expected_headings = {
        ...
        "backend/packages/harness/agent_workspace/agents/AGENTS.md": "### Agent System",
        "backend/packages/harness/agent_workspace/agents/middlewares/AGENTS.md": "### Middleware Chain",
        "backend/packages/harness/agent_workspace/agents/memory/AGENTS.md": "### Memory System",
        "backend/packages/harness/agent_workspace/config/AGENTS.md": "### Configuration System",
        "backend/packages/harness/agent_workspace/extensions/AGENTS.md": "### Python Extension System",
        "backend/packages/harness/agent_workspace/runtime/AGENTS.md": "### Checkpoint Channel Modes",
        "backend/packages/harness/agent_workspace/sandbox/AGENTS.md": "### Sandbox System",
        "backend/packages/harness/agent_workspace/mcp/AGENTS.md": "### MCP System",
        "backend/packages/harness/agent_workspace/models/AGENTS.md": "### Model Factory",
        "backend/packages/harness/agent_workspace/persistence/migrations/AGENTS.md": "### Schema Migrations",
        "backend/packages/harness/agent_workspace/reflection/AGENTS.md": "### Reflection System",
        "backend/packages/harness/agent_workspace/skills/AGENTS.md": "### Skills System",
        "backend/packages/harness/agent_workspace/subagents/AGENTS.md": "### Subagent System",
        "backend/packages/harness/agent_workspace/tools/AGENTS.md": "### Tool System",
        "backend/packages/harness/agent_workspace/tracing/AGENTS.md": "### Tracing System",
        "backend/packages/harness/agent_workspace/tui/AGENTS.md": "### Terminal Workbench / TUI",
