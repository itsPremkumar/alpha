...
def test_local_guidance_files_contain_the_split_original_sections() -> None:
    expected_headings = {
        ...
        "backend/packages/harness/alpha/agents/AGENTS.md": "### Agent System",
        "backend/packages/harness/alpha/agents/middlewares/AGENTS.md": "### Middleware Chain",
        "backend/packages/harness/alpha/agents/memory/AGENTS.md": "### Memory System",
        "backend/packages/harness/alpha/config/AGENTS.md": "### Configuration System",
        "backend/packages/harness/alpha/extensions/AGENTS.md": "### Python Extension System",
        "backend/packages/harness/alpha/runtime/AGENTS.md": "### Checkpoint Channel Modes",
        "backend/packages/harness/alpha/sandbox/AGENTS.md": "### Sandbox System",
        "backend/packages/harness/alpha/mcp/AGENTS.md": "### MCP System",
        "backend/packages/harness/alpha/models/AGENTS.md": "### Model Factory",
        "backend/packages/harness/alpha/persistence/migrations/AGENTS.md": "### Schema Migrations",
        "backend/packages/harness/alpha/reflection/AGENTS.md": "### Reflection System",
        "backend/packages/harness/alpha/skills/AGENTS.md": "### Skills System",
        "backend/packages/harness/alpha/subagents/AGENTS.md": "### Subagent System",
        "backend/packages/harness/alpha/tools/AGENTS.md": "### Tool System",
        "backend/packages/harness/alpha/tracing/AGENTS.md": "### Tracing System",
        "backend/packages/harness/alpha/tui/AGENTS.md": "### Terminal Workbench / TUI",
