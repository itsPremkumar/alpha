...
from agent_workspace_extension_api.assembly import (
    AgentAssemblyDescriptor,
    AgentAssemblyObserver,
    MiddlewareDescriptor,
    ToolDescriptor,
)
from agent_workspace_extension_api.auth import (
    EXTENSION_PRINCIPAL_RESOLVER_KEY,
    ExtensionPrincipal,
    require_admin,
    resolve_principal,
)
from agent_workspace_extension_api.compaction import (
    CompactionEvent,
    ContextCompactionObserver,
)
from agent_workspace_extension_api.contracts import (
    ExtensionInstall,
    ExtensionRegistry,
...
from agent_workspace_extension_api.placement import (
    AgentBuildContext,
    AgentScope,
    MiddlewarePlacement,
    Placement,
)
from agent_workspace_extension_api.provenance import (
...
from agent_workspace_extension_api.release import (
