...
if TYPE_CHECKING:  # pragma: no cover - typing only
    from agent_workspace_extension_api.assembly import AgentAssemblyObserver
    from agent_workspace_extension_api.compaction import ContextCompactionObserver
    from agent_workspace_extension_api.placement import AgentBuildContext, MiddlewarePlacement
