...
2. **Run-time execution deny** — reuses :class:`~agent_workspace.guardrails.middleware.GuardrailMiddleware`
   via a thin adapter (see :mod:`agent_workspace.authz.adapter`), catching dynamic
