...
from agent_workspace.swarm.models import SwarmDecision, SwarmEvent, SwarmMode, SwarmPlan, TaskNodeState
...
class SwarmCoordinator:
    ...
    def dynamic_expand(
        ...
        from agent_workspace.swarm.models import SwarmTaskNode, TaskNodeState
