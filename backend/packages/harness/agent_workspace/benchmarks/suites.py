...
from agent_workspace.benchmarks import BenchmarkCase, BenchmarkSuite


def _dm_matrix_evaluator(case: BenchmarkCase) -> tuple[bool, float, str]:
    from agent_workspace.bots.dm import parse_dm_target, send_dm
...
def _wake_gate_evaluator(case: BenchmarkCase) -> tuple[bool, float, str]:
    from agent_workspace.scheduler.guards import guard_scheduled_prompt
