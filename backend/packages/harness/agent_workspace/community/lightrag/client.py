"""Minimal asynchronous client for the LightRAG APIs Alpha consumes."""
...
class LightRAGClient:
    """Direct HTTP client for Alpha's read-only retrieval tools.
    ...
    async def query_data(
        ...
        *,
        ...
        read-only shape Alpha's knowledge tool consumes.
        """
