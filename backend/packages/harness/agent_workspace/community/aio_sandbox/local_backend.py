...
_NETWORK_POLICY_DIGEST_LABEL = "agent_workspace.network_policy_digest"
...
class LocalContainerBackend(SandboxBackend):
    ...
    def _sandbox_labels(self, sandbox_id: str) -> dict[str, str]:
        ...
        return {
            ...
            "agent_workspace.network_mode": self._network_mode,
        }
    ...
    def _persisted_sandbox_mode(self, sandbox: _ContainerInspection, sandbox_id: str) -> str | None:
        ...
        role = labels.get("agent_workspace.role")
        labelled_id = labels.get("agent_workspace.sandbox_id")
        labelled_mode = labels.get("agent_workspace.network_mode")
