...
from agent_workspace.subagents.report_contract import MAX_ACCEPTANCE_CRITERIA, normalize_acceptance_criteria
...
def _probe_file_size(runtime: Any, resolved: str, thread_data: Mapping[str, Any] | None) -> int | None:
    ...
    """
    try:
        from agent_workspace.sandbox.tools import _resolve_local_read_path, ensure_sandbox_initialized, is_local_sandbox
...
def check_acceptance_criteria(
    ...
    *,
    ...
    if content_reader is None:
        ...
        from agent_workspace.sandbox.tools import read_current_file_content
