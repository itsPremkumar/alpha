...
from agent_workspace.subagents.acceptance_checks import AcceptanceVerdict, check_acceptance_criteria, parse_file_criterion
from agent_workspace.subagents.report_contract import normalize_acceptance_criteria
...
async def check_batch_acceptance(
    ...
    *,
    ...
    from agent_workspace.sandbox.lease import SANDBOX_LEASE_OWNER_CONTEXT_KEY, acquire_sandbox_client_lease, run_sync_lifecycle_operation
