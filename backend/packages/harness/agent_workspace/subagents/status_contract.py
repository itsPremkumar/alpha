...
- ``subagent_model_name`` (optional): effective Alpha model identifier used
...
from agent_workspace.agents.middlewares.receipt_verification import ReceiptVerdict, validate_receipt_verdict
from agent_workspace.agents.middlewares.tool_receipt import is_valid_receipt
from agent_workspace.subagents.acceptance_checks import AcceptanceVerdict, validate_acceptance_verdict
