...
from agent_workspace.config.runtime_paths import resolve_path
from agent_workspace.constants import DEFAULT_SKILLS_CONTAINER_PATH
from agent_workspace.skills.permissions import make_skill_written_path_sandbox_readable
from agent_workspace.skills.storage.skill_storage import SKILL_MD_FILE, SkillStorage
...
class LocalSkillStorage(SkillStorage):
    ...
    async def ainstall_skill_from_archive(self, archive_path: str | Path) -> dict:
        from agent_workspace.skills.installer import _scan_skill_archive_contents_or_raise
    ...
    def _prepare_skill_archive(self, path: Path, tmp_path: Path, custom_dir: Path, archive_path: str | Path) -> tuple[Path, str, Path]:
        ...
        from agent_workspace.skills.installer import (
            SkillAlreadyExistsError,
            resolve_skill_dir_from_archive,
            safe_extract_skill_archive,
            scan_archive_preflight_or_raise,
        )
        from agent_workspace.skills.validation import _validate_skill_frontmatter
    ...
    def _commit_skill_install(self, skill_dir: Path, skill_name: str, custom_dir: Path, target: Path) -> None:
        ...
        from agent_workspace.skills.installer import _move_staged_skill_into_reserved_target
    ...
    def _skill_projection_mutation(
        ...
        *,
        ...
        if getattr(self, "user_id", None) is None:
            from agent_workspace.skills.projection import _projection_lock
