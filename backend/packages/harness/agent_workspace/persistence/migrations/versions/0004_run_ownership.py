...
def upgrade() -> None:
    from agent_workspace.persistence.migrations._helpers import safe_add_column
...
def downgrade() -> None:
    ...
    from agent_workspace.persistence.migrations._helpers import safe_drop_column
