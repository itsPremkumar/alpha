...
Usage (e.g. FastAPI lifespan)::
    ...
    from agent_workspace.runtime.store import make_store
...
from agent_workspace.persistence.postgres_schema import dsn_with_search_path, ensure_postgres_schema_async
from agent_workspace.runtime.store.provider import (
