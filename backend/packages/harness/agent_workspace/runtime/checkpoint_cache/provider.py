...
from agent_workspace.runtime.checkpoint_cache.base import CACHE_FORMAT_VERSION, CheckpointHistoryCache
...
async def make_checkpoint_cache(
    ...
    *,
    ...
    if config.type == "redis":
        from agent_workspace.runtime.checkpoint_cache.redis import RedisCheckpointHistoryCache
