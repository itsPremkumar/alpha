...
from agent_workspace.runtime.sentinel.loop import LoopOutcome, SentinelLoop
from agent_workspace.runtime.sentinel.signals import Signal, SignalTracker
from agent_workspace.runtime.sentinel.sources import logs as log_sources
from agent_workspace.runtime.sentinel.sources import scripts as script_sources
from agent_workspace.runtime.sentinel.verify import Verifier
...
def make_default_fix_fns(repo_root: str | Path) -> dict[str, Callable[[Signal, Any], list[str]]]:
    ...
    def fix_missing_bom(signal: Signal, snapshot: Any) -> list[str]:
        from agent_workspace.runtime.sentinel.sources import scripts
