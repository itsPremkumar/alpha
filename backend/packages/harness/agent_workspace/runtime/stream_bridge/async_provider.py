...
Usage (e.g. FastAPI lifespan)::
    ...
    from agent_workspace.agents.stream_bridge import make_stream_bridge
...
from agent_workspace.config.stream_bridge_config import StreamBridgeConfig, get_stream_bridge_config
