...
from agent_workspace.agents.thread_state import SandboxStateField, ThreadDataState
...
from agent_workspace.sandbox.sandbox_provider import get_initialized_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    def _prepare_agent_skill_projection(self, thread_id: str, *, user_id: str):
        ...
        from agent_workspace.skills.projection import ensure_thread_skill_projection
