...
from agent_workspace.perpetual.discovery import AutonomousTaskDiscoveryEngine
from agent_workspace.perpetual.memory_consolidator import PerpetualMemoryConsolidator
from agent_workspace.perpetual.models import (
    AutonomousTask,
    DaemonState,
...
from agent_workspace.perpetual.stagnation import StagnationRecoveryWatchdog
...
class PerpetualDaemon:
    ...
    def step_heartbeat(self) -> dict[str, Any]:
        ...
        try:
            from agent_workspace.enterprise.heartbeat import get_enterprise_heartbeat_coordinator
