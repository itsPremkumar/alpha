...
class GitHubWorkforceBridge:
    ...
    def dispatch_event(
        ...
        if event_type == "issues" and action in ("opened", "reopened", "labeled"):
            ...
            try:
                from agent_workspace.projects.auction_engine import get_auction_engine
        ...
        # 2. Pull Request Created / Updated -> Trigger Pre-Merge Audit Council
            ...
            try:
                from agent_workspace.projects.audit_council import get_audit_council
        ...
        # 3. CI Workflow Run Failed -> Trigger Self-Healing Runner
            ...
            try:
                import uuid
                from agent_workspace.projects.self_healing_runner import TestRunResult, get_self_healing_runner
