...
A tool is "MCP-sourced" when it carries the ``agent_workspace_mcp`` metadata flag.
...
MCP_TOOL_METADATA_KEY = "agent_workspace_mcp"
MCP_TOOL_ROUTING_METADATA_KEY = "agent_workspace_mcp_routing"
MCP_TOOL_SOURCE_METADATA_KEY = "agent_workspace_mcp_source"
