...
import agent_workspace.checkpoint_patches as _checkpoint_patches  # noqa: F401 - import-time saver fixes
from agent_workspace.agents.goal_state import GoalState
from agent_workspace.agents.task_continuity.state import TaskNotesChannel, merge_task_notes
...
def _resolve_snapshot_frequency(snapshot_frequency: int | None) -> int:
    ...
    from agent_workspace.runtime.checkpoint_mode import resolve_checkpoint_snapshot_frequency
