...
from agent_workspace.config.summarization_config import DEFAULT_KEEP
from agent_workspace.config.task_continuity_config import TaskContinuityConfig
from agent_workspace.extensions.notify import notify_context_compacted
from agent_workspace.models import create_chat_model
from agent_workspace.utils.messages import is_real_user_message
...
class DeerFlowSummarizationMiddleware(SummarizationMiddleware):
        ...
        *,
        ...
        try:
            ...
            if extensions is None:
                ...
                from agent_workspace.extensions.notify import observe_system_model_call
    ...
    def compact_state(
        ...
        *,
        ...
        if self._task_continuity_config is not None:
            from agent_workspace.agents.task_continuity.archive import capture
    ...
    async def acompact_state(
        ...
        *,
        ...
        task_history = None
        if self._task_continuity_config is not None:
            from agent_workspace.agents.task_continuity.archive import acapture
