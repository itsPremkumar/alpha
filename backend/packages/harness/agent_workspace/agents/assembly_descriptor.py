...
from agent_workspace.tools.mcp_metadata import get_mcp_source, is_mcp_tool
...
def _tool_source(tool: object) -> str:
    ...
    if module.startswith("agent_workspace.tools.builtins") or module.startswith("agent_workspace.agents.memory"):
        return "builtin"
    if "skill" in module:
        return "skill"
