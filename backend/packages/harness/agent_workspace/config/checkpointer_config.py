...
from agent_workspace.config.postgres_schema import POSTGRES_SCHEMA_PATTERN, validate_postgres_schema
...
def ensure_config_loaded() -> None:
    ...
    from agent_workspace.config.app_config import _app_config, get_app_config
