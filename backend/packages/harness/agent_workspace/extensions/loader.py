...
from agent_workspace.extensions.registry import ExtensionRegistry, LoadedExtensions
...
class ExtensionSpec(BaseModel):
    ...
    table_prefix: str | None = Field(
        ...
        description=(
            ...
            "agent_workspace.persistence.migrations._env_filters so alembic revision --autogenerate "
