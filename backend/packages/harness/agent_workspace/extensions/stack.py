...
This is where Alpha's stack shape is encoded. Two structural facts drive it:
...
from agent_workspace.extensions.anchors import (
    PlacementAnchor,
    inner_of_last,
    inner_of_last_after,
    innermost,
...
from agent_workspace.extensions.ordering import assert_ordering
from agent_workspace.extensions.registry import LoadedExtensions
...
def compose_with_extensions(
    ...
    """
    from agent_workspace.extensions import get_agent_build_extensions, record_runtime_diagnostic
...
def _record_diagnostics(diagnostics) -> None:
    ...
    from agent_workspace.extensions import record_runtime_diagnostics
