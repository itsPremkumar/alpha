...
:class:`~alpha.sandbox.exceptions.SandboxAuthorizationError` propagates up
...
from alpha.authz.runtime import construct_authorization_provider, resolve_authorization_provider, resolve_authorization_provider_spec
