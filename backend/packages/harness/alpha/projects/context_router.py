...
2. Level 2: Shared Project Memory (~/.alpha/projects/<project>/context.json) - Architecture, ADRs, constitution, active locks
...
from alpha.projects import constitution as constitution_mod
from alpha.projects import decisions as decisions_mod
...
class ThreeLevelContextRouter:
    ...
    def get_project_memory(self, project_id: str) -> dict[str, Any]:
        ...
        try:
            from alpha.projects.memory_bridge import build_memory_extras
