...
from alpha.agents.thread_state import SandboxStateField, ThreadDataState
...
from alpha.sandbox.sandbox_provider import get_initialized_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    def _prepare_agent_skill_projection(self, thread_id: str, *, user_id: str):
        ...
        from alpha.skills.projection import ensure_thread_skill_projection
    ...
    #
    # Background:
    #   ``ensure_sandbox_initialized*`` in ``alpha.sandbox.tools`` mutates
