...
from alpha.sandbox.path_patterns import replace_output_path_matches
...
class LocalSandbox(Sandbox):
    ...
    def _run_posix_command(
        ...
        stdout_capture, stdout_thread = LocalSandbox._start_pipe_drain(stdout_read_fd, "alpha-bash-stdout-drain")
        stderr_capture, stderr_thread = LocalSandbox._start_pipe_drain(stderr_read_fd, "alpha-bash-stderr-drain")
        try:
