...
from alpha.agents.middlewares.receipt_verification import verify_receipt_citations
from alpha.authz.principal import normalize_authz_attributes
from alpha.config import get_app_config
from alpha.extensions import resolve_run_extensions
from alpha.runtime.user_context import resolve_runtime_user_id
from alpha.sandbox.security import LOCAL_BASH_SUBAGENT_DISABLED_MESSAGE, is_host_bash_allowed
from alpha.subagents import SubagentExecutor, get_available_subagent_names, get_subagent_config
from alpha.subagents.acceptance_checks import check_acceptance_criteria, render_acceptance_section
...
async def task_tool(
    ...
    *,
    ...
    from alpha.subagents.categories import CategoryResolutionError, apply_category
