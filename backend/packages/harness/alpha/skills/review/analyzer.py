...
from alpha.skills.frontmatter import ALLOWED_FRONTMATTER_PROPERTIES, split_skill_markdown
from alpha.skills.package_paths import is_eval_fixture_path, is_eval_fixture_skill_md
from alpha.skills.parser import parse_allowed_tools, parse_required_secrets
from alpha.skills.review.digest import compute_package_digest
from alpha.skills.review.eval_schema import analyze_eval_manifests
...
from alpha.skills.review.resource_graph import build_resource_graph
from alpha.skills.skillscan.orchestrator import scan_skill_dir


def analyze_skill_package(snapshot: dict[str, Any], *, profile: ProfileName = "alpha") -> dict[str, Any]:
