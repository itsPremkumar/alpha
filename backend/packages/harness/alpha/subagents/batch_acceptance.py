...
from alpha.subagents.acceptance_checks import AcceptanceVerdict, check_acceptance_criteria, parse_file_criterion
...
async def check_batch_acceptance(
    ...
    *,
    ...
    from alpha.sandbox.lease import SANDBOX_LEASE_OWNER_CONTEXT_KEY, acquire_sandbox_client_lease, run_sync_lifecycle_operation
