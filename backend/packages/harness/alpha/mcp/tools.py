...
from alpha.config.extensions_config import ExtensionsConfig, McpServerConfig, resolve_effective_mcp_routing
from alpha.config.paths import VIRTUAL_PATH_PREFIX, Paths, get_paths
from alpha.constants import DEFAULT_MCP_SESSION_INIT_TIMEOUT, MCP_TMP_SUBDIR
from alpha.mcp.client import build_servers_config
from alpha.mcp.headers import apply_header_overrides
from alpha.mcp.interceptors import build_mcp_tool_interceptors, compose_tool_interceptors
from alpha.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
from alpha.mcp.session_pool import call_pooled_session_tool, get_session_pool
from alpha.mcp.tasks import ORDINARY_MCP_TASK_DRIVER, TaskSubmitRequest
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as alpha client streams synchronously
