...
When enabled, a pluggable :class:`~alpha.authz.provider.AuthorizationProvider`
...
run-time execution deny (reuses :class:`~alpha.guardrails.middleware.GuardrailMiddleware`
...
class AuthorizationProviderConfig(BaseModel):
    ...
    use: str = Field(description="Class path (e.g. 'alpha.authz.rbac:RbacAuthorizationProvider')")
...
class AuthorizationConfig(BaseModel):
    ...
    Mirrors :class:`~alpha.config.guardrails_config.GuardrailsConfig` in
