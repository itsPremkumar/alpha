...
class LocalContainerBackend(SandboxBackend):
    ...
    def _sandbox_labels(self, sandbox_id: str) -> dict[str, str]:
        ...
        return {
            ...
            "alpha.role": "sandbox",
            "alpha.network_mode": self._network_mode,
        }
    ...
    def _persisted_sandbox_mode(self, sandbox: _ContainerInspection, sandbox_id: str) -> str | None:
        ...
        role = labels.get("alpha.role")
        labelled_id = labels.get("alpha.sandbox_id")
        labelled_mode = labels.get("alpha.network_mode")
        identity_keys_present = any(key in labels for key in ("alpha.role", "alpha.sandbox_id", "alpha.network_mode"))
