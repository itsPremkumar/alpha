...
def _reflect_state(sync_conn: Any) -> dict[str, bool]:
    ...
    try:
        ...
        logger.debug("alpha.persistence.models not found; metadata may be incomplete")
...
def _run_create_all_sync(sync_conn: Any) -> None:
    ...
    try:
        ...
        logger.debug("alpha.persistence.models not found; bootstrap will create empty schema")
...
def _run_baseline_create_all_sync(sync_conn: Any) -> None:
    ...
    try:
        ...
        logger.debug("alpha.persistence.models not found; baseline backfill may be incomplete")
