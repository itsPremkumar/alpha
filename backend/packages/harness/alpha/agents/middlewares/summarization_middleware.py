...
from alpha.config.summarization_config import DEFAULT_KEEP
from alpha.config.task_continuity_config import TaskContinuityConfig
from alpha.extensions.notify import notify_context_compacted
from alpha.models import create_chat_model
from alpha.utils.messages import is_real_user_message
...
class AgentWorkspaceSummarizationMiddleware(SummarizationMiddleware):
    ...
    def compact_state(
        ...
        *,
        ...
        if self._task_continuity_config is not None:
            from alpha.agents.task_continuity.archive import capture
    ...
    async def acompact_state(
        ...
        *,
        ...
        task_history = None
        if self._task_continuity_config is not None:
            from alpha.agents.task_continuity.archive import acapture
