...
from alpha.uploads.manager import is_upload_staging_file
from alpha.utils.file_outline import extract_outline_for_file
...
class UploadsMiddleware(AgentMiddleware[UploadsMiddlewareState]):
    ...
    async def abefore_agent(self, state: UploadsMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        LangGraph's runnable config and Alpha's request ContextVar fallback.
