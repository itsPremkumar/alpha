...
from alpha.runtime.user_context import AUTO, _AutoSentinel, resolve_user_id
from alpha.utils.time import is_lease_expired
from alpha.utils.time import now_iso as _now_iso
...
class RunManager:
    ...
    async def _admit_thread_operation(
        ...
        *,
        ...
        try:
            ...
            cleanup.set_name(f"alpha-close-cancelled-admission-{record.run_id}")
    ...
    async def start_heartbeat(self) -> None:
        ...
        task.set_name("alpha-run-lease-heartbeat")
    ...
    def _schedule_orphan_reconciliation(self) -> None:
        ...
        task.set_name("alpha-periodic-orphan-recovery")
