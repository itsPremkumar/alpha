...
from alpha.persistence.migrations.run_events_fts_ddl import (
    FTS_TABLE,
    PG_INDEX_DDL,
    PG_TEXT_PROJECTION,
    PG_TSVECTOR_EXPR,
...
from alpha.runtime.events.message_identity import message_identity
...
from alpha.runtime.user_context import AUTO, _AutoSentinel, get_current_user, resolve_user_id
...
class DbRunEventStore(RunEventStore):
    ...
    async def search_message_content(
        ...
        *,
        ...
        from alpha.runtime.events.search import DEFAULT_SNIPPET_CHARS
