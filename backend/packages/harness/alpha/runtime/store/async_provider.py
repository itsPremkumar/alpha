...
Usage (e.g. FastAPI lifespan)::
    ...
    from alpha.runtime.store import make_store
...
from alpha.persistence.postgres_schema import dsn_with_search_path, ensure_postgres_schema_async
from alpha.runtime.store.provider import (
...
async def _async_store(config) -> AsyncIterator[BaseStore]:
    ...
    The ``config`` argument is a :class:`alpha.config.checkpointer_config.CheckpointerConfig`
