...
from alpha.extensions.ordering import assert_ordering
from alpha.extensions.registry import LoadedExtensions
...
def compose_with_extensions(
    ...
    """
    from alpha.extensions import get_agent_build_extensions, record_runtime_diagnostic
...
def _record_diagnostics(diagnostics) -> None:
    ...
    from alpha.extensions import record_runtime_diagnostics
