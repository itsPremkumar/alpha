...
class TelegramChannel(Channel):
    ...
    async def _bind_connection_from_start_token_on_main(
        ...
        logger.info("[Telegram] bound chat=%s user=%s to Alpha user=%s connection=%s", chat_id, user_id, owner_user_id, connection["id"])
    ...
    async def _on_text(self, update, context) -> None:
        ...
        # topic_id determines which Alpha thread the message maps to.
