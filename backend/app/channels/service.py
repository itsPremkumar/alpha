...
_CHANNEL_REGISTRY: dict[str, str] = {
    ...
    "signal": "app.channels.signal:SignalChannel",
...
_CHANNELS_LANGGRAPH_URL_ENV = "AGENT_WORKSPACE_CHANNELS_LANGGRAPH_URL"
_CHANNELS_GATEWAY_URL_ENV = "AGENT_WORKSPACE_CHANNELS_GATEWAY_URL"
