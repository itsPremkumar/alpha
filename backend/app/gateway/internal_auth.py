...
def create_internal_auth_headers(*, owner_user_id: str | None = None) -> dict[str, str]:
    ...
    headers = {
        ...
        LEGACY_INTERNAL_AUTH_HEADER_NAME: _INTERNAL_AUTH_TOKEN,
    }
    if owner_user_id:
        headers[INTERNAL_OWNER_USER_ID_HEADER_NAME] = owner_user_id
        headers[LEGACY_INTERNAL_OWNER_USER_ID_HEADER_NAME] = owner_user_id
    return headers
...
def get_trusted_internal_owner_user_id(request: Any) -> str | None:
    ...
    owner_user_id = request.headers.get(INTERNAL_OWNER_USER_ID_HEADER_NAME) or request.headers.get(
        LEGACY_INTERNAL_OWNER_USER_ID_HEADER_NAME
    )
