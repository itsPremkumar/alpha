...
| Environment healing   | `runtime/environment_auto_healer.py` (612 LOC)                                                                                    | ✅ `diagnose_and_heal_environment` tool, registered in `tools/builtins/__init__.py:153`             |
...
| Bot profiles          | `bots/templates.py` — **19** templates                                                                                            | ✅ includes `sre` and `devops`                                                                      |
