...
LLM_PROVIDERS: list[LLMProvider] = [
    ...
    LLMProvider(
        ...
        use="alpha.models.mindie_provider:MindIEChatModel",
...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="alpha.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="alpha.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="alpha.community.firecrawl.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="alpha.community.fastcrw.tools:web_search_tool",
        env_var="CRW_API_KEY",
        extra_config={"max_results": 5},
    ),
    SearchProvider(
    ...
    SearchProvider(
        ...
        use="alpha.community.serply.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="alpha.community.sofya.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="alpha.community.groundroute.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="alpha.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="alpha.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="alpha.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="alpha.community.groundroute.tools:web_fetch_tool",
        env_var="GROUNDROUTE_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="alpha.community.fastcrw.tools:web_fetch_tool",
        env_var="CRW_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="alpha.community.sofya.tools:web_fetch_tool",
        env_var="SOFYA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="alpha.community.crawl4ai.tools:web_fetch_tool",
        env_var=None,
        tool_name="web_fetch",
