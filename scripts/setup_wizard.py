#!/usr/bin/env python3
"""Alpha Setup Wizard (interactive + unattended).
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Alpha setup wizard")
    parser.add_argument(
        "--non-interactive",
        action="store_true",
...
def _persist_configuration(
    ...
    print(f"  {cyan('make dev')}        # Start Alpha")
    print()
...
def _run_interactive() -> int:
    ...
    print()
    print(bold("Welcome to Alpha Setup!"))
    print("This wizard will help you configure Alpha in a few minutes.")
    print()
